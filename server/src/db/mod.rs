...
impl Database {
    pub async fn new(config: &AppConfig) -> anyhow::Result<Database> {
    ...
    pub async fn create_user(&self, username: String, password: String) -> anyhow::Result<User> {
        let user: User =
    ...
    pub async fn get_user_by_name(&self, username: String) -> anyhow::Result<Option<User>> {
    ...
    pub async fn create_file(&self, file_name: &str, content_type: &str, file_size: i64, vault_id: i64, user_id: i32) -> anyhow::Result<VaultFile> {
    ...
    pub async fn list_vaults(&self, user_id: i32) -> anyhow::Result<Vec<Vault>> {
    ...
    pub async fn delete_vault(&self, user_id: i32, vault_id: i64) -> anyhow::Result<()> {
